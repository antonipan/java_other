package ru.anton.lesson02.draw_pic.sprites;

import ru.anton.lesson02.common.MainCanvas;
import ru.anton.lesson02.common.Sprite;
...
public class Picture extends Sprite {
    ...
    public Picture(int x, int y){
        ...
        halfWidth = 62;
        try {
            image = ImageIO.read(new File("src/main/java/ru/anton/lesson02/draw_pic/resource/picachu.png"));
        } catch (IOException e) {
