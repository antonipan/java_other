package ru.anton.lesson02.draw_pic.view;

import ru.anton.lesson02.circles.exceptions.BallsOverflowException;
import ru.anton.lesson02.common.*;
import ru.anton.lesson02.draw_pic.sprites.Background;
import ru.anton.lesson02.draw_pic.sprites.Picture;
...
public class MainWindow extends JFrame implements CanvasRepaintListener, Thread.UncaughtExceptionHandler {
    ...
    public void addSprite(int x, int y){
        ...
        sprites[countSprites++] = (Interactable) new Picture(x, y);
    }
